    ...
    <main>
      ...
      <section className="relative  py-16 md:py-20 border-t border-gray-200">
        <div className="container-page text-center">
          ...
          >
              a doorstep visit in {business.location.city} and let our technicians handle the rest.
          </motion.p>
          <motion.div
            variants={fadeUp}
            initial="hidden"
      ...
      <section className="relative py-16 md:py-20 border-t border-gray-200">
        <div className="container-page grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <h2 className="section-heading mb-6">  your doorstep visit</h2>
